namespace PluginPile.Unmaintained.BWTool {
  partial class DLCForm {
    ...
    private void InitializeComponent() {
      ...
      // button2
      //
      button2.Location = new Point(7, 55);
      ...
      groupBox2.Location = new Point(200, 14);
      ...
      // button3
      //
      button3.Location = new Point(7, 55);
      ...
      // button4
      //
      button4.Location = new Point(7, 22);
      ...
      groupBox3.Location = new Point(385, 14);
      ...
      // button5
      //
      button5.Location = new Point(7, 55);
      ...
      groupBox4.Location = new Point(385, 115);
      groupBox4.Margin = new Padding(4, 3, 4, 3);
      groupBox4.Name = "groupBox4";
      groupBox4.Padding = new Padding(4, 3, 4, 3);
      groupBox4.Size = new Size(178, 95);
      groupBox4.TabIndex = 6;
      groupBox4.TabStop = false;
      groupBox4.Text = "PWT 3";
      //
      // button7
      //
      button7.Location = new Point(7, 55);
      ...
      // button8
      //
      button8.Location = new Point(7, 22);
      ...
      groupBox5.Location = new Point(200, 115);
      groupBox5.Margin = new Padding(4, 3, 4, 3);
      groupBox5.Name = "groupBox5";
      groupBox5.Padding = new Padding(4, 3, 4, 3);
      groupBox5.Size = new Size(178, 95);
      groupBox5.TabIndex = 5;
      groupBox5.TabStop = false;
      groupBox5.Text = "PWT 2";
      //
      // button9
      //
      button9.Location = new Point(7, 55);
      ...
      // button10
      //
      button10.Location = new Point(7, 22);
      ...
      groupBox6.Location = new Point(14, 115);
      groupBox6.Margin = new Padding(4, 3, 4, 3);
      groupBox6.Name = "groupBox6";
      groupBox6.Padding = new Padding(4, 3, 4, 3);
      groupBox6.Size = new Size(178, 95);
      groupBox6.TabIndex = 4;
      groupBox6.TabStop = false;
      groupBox6.Text = "PWT 1";
      //
      // button11
      //
      button11.Location = new Point(7, 55);
      ...
      // saveexit_but
      //
      saveexit_but.Location = new Point(328, 217);
      ...
      // exit_but
      //
      exit_but.Location = new Point(134, 217);
