namespace PluginPile.Unmaintained.BWTool {
  partial class KeySystemForm {
    ...
    private void InitializeComponent() {
      ...
      groupBox1.Location = new Point(27, 14);
      ...
      // icebergkeybox
      //
      icebergkeybox.Location = new Point(7, 50);
      icebergkeybox.Margin = new Padding(4, 3, 4, 3);
      ...
      // easykeybox
      //
      easykeybox.Location = new Point(7, 22);
      easykeybox.Margin = new Padding(4, 3, 4, 3);
      ...
      groupBox2.Location = new Point(279, 14);
      ...
      // ironkeybox
      //
      ironkeybox.Location = new Point(7, 50);
      ironkeybox.Margin = new Padding(4, 3, 4, 3);
      ...
      // challengekeybox
      //
      challengekeybox.Location = new Point(7, 22);
      challengekeybox.Margin = new Padding(4, 3, 4, 3);
      ...
      // citykeybox
      //
      citykeybox.Location = new Point(191, 110);
      citykeybox.Margin = new Padding(4, 3, 4, 3);
      ...
      groupBox3.Location = new Point(34, 144);
      ...
      // icebergbox
      //
      icebergbox.Location = new Point(340, 48);
      icebergbox.Margin = new Padding(4, 3, 4, 3);
      ...
      // ironbox
      //
      ironbox.Location = new Point(340, 22);
      ironbox.Margin = new Padding(4, 3, 4, 3);
      ...
      // citybox
      //
      citybox.Location = new Point(162, 22);
      citybox.Margin = new Padding(4, 3, 4, 3);
      ...
      // challengemodebox
      //
      challengemodebox.Location = new Point(7, 48);
      challengemodebox.Margin = new Padding(4, 3, 4, 3);
      ...
      // easymodebox
      //
      easymodebox.Location = new Point(7, 22);
      easymodebox.Margin = new Padding(4, 3, 4, 3);
      ...
      // Saveexit_but
      //
      Saveexit_but.Location = new Point(408, 385);
      ...
      // Exit_but
      //
      Exit_but.Location = new Point(34, 385);
      ...
      cfg_mode_def.Location = new Point(7, 18);
      cfg_mode_def.Margin = new Padding(4, 3, 4, 3);
      ...
      cfg_mode_1.Location = new Point(7, 42);
      cfg_mode_1.Margin = new Padding(4, 3, 4, 3);
      ...
      cfg_mode_2.Location = new Point(7, 63);
      cfg_mode_2.Margin = new Padding(4, 3, 4, 3);
      ...
      cfg_mode_3.Location = new Point(7, 85);
      cfg_mode_3.Margin = new Padding(4, 3, 4, 3);
      ...
      cfg_city_def.Location = new Point(15, 20);
      cfg_city_def.Margin = new Padding(4, 3, 4, 3);
      ...
      cfg_city_game.Location = new Point(15, 44);
      cfg_city_game.Margin = new Padding(4, 3, 4, 3);
      ...
      cfg_city_foreing.Location = new Point(15, 65);
      cfg_city_foreing.Margin = new Padding(4, 3, 4, 3);
      ...
      cfg_chamber_def.Location = new Point(26, 18);
      cfg_chamber_def.Margin = new Padding(4, 3, 4, 3);
      ...
      cfg_chamber_rock.Location = new Point(26, 42);
      cfg_chamber_rock.Margin = new Padding(4, 3, 4, 3);
      ...
      cfg_chamber_iron.Location = new Point(26, 63);
      cfg_chamber_iron.Margin = new Padding(4, 3, 4, 3);
      ...
      cfg_chamber_ice.Location = new Point(26, 85);
      cfg_chamber_ice.Margin = new Padding(4, 3, 4, 3);
      ...
      groupBox4.Location = new Point(34, 246);
      ...
      groupBox5.Location = new Point(176, 246);
      ...
      groupBox6.Location = new Point(342, 246);
