...
internal static class Language {
  ...
  public static string[] DojoWattDonationQuestProgress {
    get {
      return GameInfo.CurrentLanguage switch {
        "zh"      => ["未激活", "和蜜叶谈过了", "可改变发型", "洛托米安装", "洛托米功能","自动贩卖机可购买美味之水", "自动贩卖机可购买劲爽汽水", "自动贩卖机可购买果汁牛奶", "食材定期配送服务", "自动贩卖机可购买攻击/防御增强剂", "自动贩卖机可购买特攻/特防增强剂", "自动贩卖机可购买HP/速度增强剂", "联盟卡背景", "收到蜜叶的联盟卡", "可与蜜叶对战", "收到蜜叶的稀有联盟卡"],
  ...
  public static string[] SwordsOfJusticeQuestProgress {
    get {
      return GameInfo.CurrentLanguage switch {
        "zh"      => ["0 已报告", "1 已报告", "2 已报告", "3 报告/凯路迪欧可激活", "凯路迪欧已捕获", "凯路迪欧已报告"],
